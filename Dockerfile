...
ENV LD_LIBRARY_PATH="$HOME/speaches/.venv/lib/python3.12/site-packages/ctranslate2.libs:$HOME/speaches/.venv/lib/python3.12/site-packages/nvidia/cudnn/lib:${LD_LIBRARY_PATH:-}"
